...
def update_playback(user, room, action, action_data):
    return_data = None
...
async def get_room_state(user, room_code, update_listing = False):
    ...
    return {
        ...
        'song_block': render_to_string('core/blocks/room/playlist-song.html')
    }
